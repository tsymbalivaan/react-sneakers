		...
		<div className="overlay">
			<div className="drawer">
				<h2 className="mb-30 d-flex justify-between">
					Корзина <img onClick={onClose} src="icons/btn.svg" className="cu-p imgBtn" alt="btn" />
				</h2>
				{items.length > 0 ? (
					<>
						<div className="d-flex flex-column flex">
							...
							<div className="cartTotalBlock">
								...
								<button onClick={onOrder} disabled={isLoading} className="greenButton">
									Оформить заказ <img src="icons/btnroad.svg" alt="button" />
								</button>
							</div>
						</div>
					</>
					...
					<>
						<Info
							image={isCompleted ? 'icons/ordered.jpg' : 'icons/box.png'}
							description={
								isCompleted
