...
export default function Card({parentID, id,title, price, imgUrl, onPlus, onFavorite, favorited = false, added = false}){
    ...
    return(
     ...
     { onFavorite && <img onClick={onClickFav} src={isFav ? 'icons/liked.svg':"icons/unliked.svg"} alt='liked'/>}
    </div>
    ...
    <div className="d-flex justify-between align-center">
      ...
      {onPlus && <img onClick={onClickPlus} src={isItemAdded(id) ? 'icons/choosen.svg':'icons/plus.svg'} alt="plus"/>}
    </div></>
      }
        </div>
    )
